...
const PurchasedModelCard = ({ model }) => {
  return (
    <div className="bg-base-200 shadow-md rounded-xl  overflow-hidden hover:shadow-2xl transition duration-200 border border-base-100">
      <img
        src={model.image}
        alt={model.name}
